...
const NAV_ITEMS: Record<UserRole, NavItem[]> = {
  ...
  lead: [
    ...
    { label: "Propose Event", href: "/lead/propose-event", icon: FilePlus      },
    { label: "My Club",       href: "/lead/my-club",     icon: Users           },
  ...
  admin: [
    ...
    { label: "Manage Roles", href: "/admin/manage-roles", icon: ShieldCheck     },
